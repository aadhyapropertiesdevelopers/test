...
const HomeBanner = () => {
  ...
  return (
    <div className="min-h-screen bg-cover bg-center bg-[url('/images/sm.png')] sm:bg-[url('/images/sm.png')] md:bg-[url('/images/md.png')] lg:bg-[url('/images/lg02.png')] flex flex-col text-[#333]">
      <Header />
      ...
      <div className="flex-grow mb-72 md:mb-0 flex justify-center md:justify-start items-center px-6 md:px-12 py-24 md:py-12">
        <div className="max-w-4xl gap-6  flex flex-col md:flex-row justify-between items-center">
          ...
          <div>
            ...
            <div className="my-4">
              <Card className="bg-white/60 backdrop-blur-md p-3 rounded-xl max-w-md border-dashed border-2 border-yellow-300 shadow-md relative">
                <div>
                  <p className="font-bold uppercase text-pink-600">A Convention Centre A/C</p>
                  <p onClick={openGoogleMaps} className="cursor-pointer text-blue-800 hover:underline">
                    40-5-6A, MG Road, Vijayawada, AP 520010
                  </p>

                  <div className="flex gap-4 mt-2 font-bold items-center text-green-700 flex-wrap">
                  ...
                  <Link href="mailto:globalgrandeurevents@gmail.com" className="text-red-500 font-bold block mt-1">
              ...
              <Link href="/about">
                <h1 className="cursor-pointer text-2xl font-bold bg-gradient-to-r from-purple-600 via-pink-500 to-orange-400 text-transparent bg-clip-text mt-2">
                  Games / Music / Food / 50+ Activities / 70+ Stalls
                </h1>
              </Link>
            </div>
          ...
          {/* Right Section */}
          <div className="bg-white/40 p-4 md:bg-transparent">
            <div className="flex justify-center mb-4">
              <Image src="/images/Fuland.png" width={500} height={500} alt="Logo" className="w-96 md:w-[800px] h-auto drop-shadow-lg" />
            </div>
