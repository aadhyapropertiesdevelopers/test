    ...
    return (
        <div className="min-h-screen bg-cover bg-center bg-black/10 bg-blend-overlay p-6 md:p-10 flex items-center justify-center flex-col bg-[url('/images/about.jpg')]">
            ...
            <Tabs defaultValue="vision" className="max-w-6xl mx-auto w-full space-y-6">
                <TabsList className="flex justify-center h-32 md:h-16 flex-wrap gap-2 mb-6 bg-gradient-to-r from-transparent via-white to-transparent p-2 rounded-xl">
                    <TabsTrigger
                        value="vision"
                ...
                <TabsContent value="vision">
                    <div className="bg-white/40 p-8 rounded-2xl shadow-sm border border-gray-100">
                        ...
                        <p className="text-lg md:text-xl text-gray-600 leading-relaxed max-h-40 md:max-h-none overflow-y-auto">
                            ...
                            If you are thinking about hosting an event, Stagekrafts is here to offer you premium services that take your event to a whole new level.
                        </p>
                    </div>
                </TabsContent>
                ...
                <TabsContent value="team">
                    <div className="p-6 rounded-2xl border border-gray-200 bg-white/40">
                            ...
                            {teamMembers.map((member, idx) => (
                                <div key={idx} className="bg-white rounded-xl overflow-hidden shadow-sm hover:shadow-md border w-64 mx-2">
                                    <div className="h-48 bg-gradient-to-r from-pink-100 to-indigo-100 flex items-center justify-center">
                                        <Image src={member.img} alt={member.name} width={200} height={200} className="w-32 h-32 rounded-full bg-gradient-to-r from-indigo-200 to-pink-200 border-4 border-white object-cover" />
                                    </div>
                ...
                <TabsContent value="reviews">
                    <div className="bg-white/40 p-6 rounded-2xl border border-gray-200">
