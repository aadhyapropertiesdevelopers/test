        ...
        <footer className="md:fixed md:bottom-0 md:left-0 md:right-0 z-50 md:bg-green-900/50 bg-green-800 py-4 px-6 text-sm text-white flex flex-row justify-between items-center gap-4">
            ...
            <div className="flex gap-4">
                <Link href="https://wa.me/919032952244" target="_blank" rel="noopener noreferrer">
                    <Icon icon="ic:baseline-whatsapp" className="text-white hover:text-green-400 text-2xl transition" />
                </Link>
                <Link href="https://www.instagram.com/kidsfunlandfair" target="_blank" rel="noopener noreferrer">
                    <Icon icon="mdi:instagram" className="text-white hover:text-pink-400 text-2xl transition" />
                </Link>
                <Link href="https://www.facebook.com/profile.php?id=61575017804597" target="_blank" rel="noopener noreferrer">
                    <Icon icon="ic:baseline-facebook" className="text-white hover:text-blue-400 text-2xl transition" />
                </Link>
            </div>
        </footer>
    );
